## 📖 ¿Qué es MainCub Studio?
**MainCub** es un grupo de desarrolladores que se especializan en hacer realidad tus ideas para tu servidor de Minecraft.
...
- **+8 años de experiencia** en el desarrollo **Java y Kotlin**.
...
- **Núcleos para modos de juego**:
  + Algunos ejemplos: **Survival, SkyBlock, Gens, PrisonOP, entre otros**.
- Minijuegos:
